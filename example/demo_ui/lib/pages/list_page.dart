        ...
        'children': [
          {
            ...
            'child': {
              'type': 'text',
              'content': 'List with itemTemplate',
          ...
          },
          {
            ...
            'child': {
              ...
              'itemTemplate': {
                'type': 'listTile',
                'leading': {'type': 'icon', 'icon': '{{item.icon}}', 'color': '#2196F3'},
                'title': {'type': 'text', 'content': '{{item.title}}'},
                'subtitle': {'type': 'text', 'content': '{{item.subtitle}}', 'style': {'color': '#666666'}},
                'trailing': {'type': 'icon', 'icon': 'chevron_right'},
                'onTap': {'type': 'tool', 'tool': 'selectItem', 'params': {'index': '{{index}}'}},
              },
            },
          },
          {
