...
class I18nManager extends ChangeNotifier {
  ...
  Future<void> loadTranslations(Map<String, dynamic> i18nConfig) async {
    ...
    if (translations != null) {
      _translations.addAll(translations.map((key, value) => 
  ...
  Future<void> _loadRemoteTranslations(String url) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _logger.error('Failed to load remote translations: ${response.statusCode}');
      }
    } catch (e) {
  ...
  void loadLocaleTranslations(String locale, Map<String, dynamic> translations) {
