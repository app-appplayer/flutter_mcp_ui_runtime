...
class VisibilityWidgetFactory extends WidgetFactory {
  ...
  Widget build(Map<String, dynamic> definition, RenderContext context) {
    ...
    final maintainInteractivity = properties['maintainInteractivity'] as bool? ?? false;
    ...
    if (properties['replacement'] != null && properties['replacement'] is Map<String, dynamic>) {
      replacement = context.renderer.renderWidget(properties['replacement'], context);
    }
