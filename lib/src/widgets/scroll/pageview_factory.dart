...
class PageViewWidgetFactory extends WidgetFactory {
  ...
  Widget build(Map<String, dynamic> definition, RenderContext context) {
    ...
    // Extract properties
    final scrollDirection = _parseAxis(properties['scrollDirection']) ?? Axis.horizontal;
    final reverse = properties['reverse'] as bool? ?? false;
    final pageSnapping = properties['pageSnapping'] as bool? ?? true;
    final allowImplicitScrolling = properties['allowImplicitScrolling'] as bool? ?? false;
    ...
    Widget pageView = PageView(
      ...
      onPageChanged: onPageChanged != null ? (index) {
