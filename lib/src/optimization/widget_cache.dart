...
class WidgetCache {
  ...
  String _generateKey(Map<String, dynamic> definition, Map<String, dynamic>? context) {
    final content = {
  ...
  /// Cache a widget
  void put(Map<String, dynamic> definition, Map<String, dynamic>? context, Widget widget) {
    if (!_enabled) {
    ...
    _logger.debug('Cached widget with key: $key (cache size: ${_cache.length})');
  }
  ...
  Map<String, dynamic> getStatistics() {
    ...
    return {
      ...
      'hitRate': _cache.isNotEmpty ? (totalHits / _cache.length).toStringAsFixed(2) : '0',
    };
  }
